    ...
    <div className="container mx-auto flex items-center py-10 lg:py-16 xl:py-32">
      <div className="mx-auto space-x-4">
        ...
        <div className='flex items-center space-x-4 py-2 px-4 lg:py-6 xl:pt-10'>
          <div className='w-56 md:w-96 bg-white rounded-full p-3 border-[1.5px] border-main'>
            <input className='bg-transparent outline-none text-main dark:text-white px-2 truncate' type="email" placeholder='Type your email address' />
          </div>
          <Button
            text="Send"

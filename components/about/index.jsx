    ...
    <div className="container mx-auto flex items-center py-10 lg:py-16 xl:py-[32]">
      <div className="mx-auto space-x-4">
        <div className="flex items-center space-x-2">
          ...
          <h3 className="text-xl md:text-4xl text-main dark:text-white font-extrabold uppercase">
            CHALLENGE ACCEPTED
          </h3>
        </div>

        <div className="w-full md:max-w-6xl">
          <p className="text-2xl lg:text-3xl text-main dark:text-white font-semibold py-4 lg:py-6 leading-8 sm:leading-10 xl:leading-[3.700rem]">
